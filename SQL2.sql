...
-- 11. Таблица "Работники и техника" (связь между работниками и техникой)
...
-- 12. Таблица "Работники и производство" (связь между работниками и производством)
CREATE TABLE EmployeeProduction (
    employee_id INT NOT NULL,
...
CREATE TABLE StorageProduction (
    ...
    PRIMARY KEY (storage_id, production_id),
...
CREATE INDEX idx_employee_production ON EmployeeProduction(employee_id);
